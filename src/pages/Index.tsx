...
const testimonials = [
  { name: "Рома и Катя", event: "Свадьба", text: "Спасибо тебе огромное за наш свадебный день! Ты сделала его таким волшебным и запоминающимся. С первых же минут ты создала лёгкую и весёлую атмосферу, в которой мы смогли просто расслабиться и насладиться праздником. Конкурсы были очень классными — гости были «согласны на всё»! Ты была не просто ведущей, а настоящим помощником и душой нашего праздника. Ты — профессионал своего дела!" },
  { name: "", event: "Вечеринка в стиле 90-х", text: "Наташа, хочу сказать тебе огромное спасибо за проведение нашего праздника. Гости сказали — было просто бомба, пушка, петарда! Мы с Олегом с ними полностью согласны. Спасибо за поддержку в минуты моей паники! Вообще спасибо за всё!" },
  { name: "Выпускники школы №17, выпуск 2025", event: "Выпускной", text: "Наташа, огромное спасибо за праздник! Особенно благодарим за порядочность, ответственность и мягкое сопровождение на всех этапах подготовки и в течение самого вечера. Никакой суеты и нервозности! Всё чётко, всё в меру, своевременно и не клишированно. И технически тоже всё сложилось прекрасно благодаря вашей слаженной работе с командой. Огромное спасибо за профессионализм и включённость!" },
  { name: "Полина", event: "Свадьба", text: "Наташа, хотели бы тебя ещё раз поблагодарить за такое огненное мероприятие! Все гости просто в нереальном восторге, видео- и фотограф обе о тебе тоже очень хорошо отозвались. Мы не пожалели ни на секунду, что у нас была такая крутая ведущая! Эмоции до сих пор переполняют. Гости до сих пор пишут, поздравляют, восхищаются. Надеюсь, это не первое наше совместное мероприятие!" },
];
                ...
                <FadeSection key={t.name} delay={(i + 1) * 0.15}>
                  <div className="p-8 border border-gold/15 hover:border-gold/40 transition-all duration-500 relative">
                    ...
                    <div className="border-t border-gold/20 pt-4">
                      {t.name && <div className="font-montserrat text-sm font-medium text-champagne">{t.name}</div>}
