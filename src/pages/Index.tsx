...
const testimonials = [
  ...
  { name: "Мы с Олегом", event: "Вечеринка в стиле 90-х", text: "Наташа, хочу сказать тебе огромное спасибо за проведение нашего праздника. Гости сказали — было просто бомба, пушка, петарда! Мы с Олегом с ними полностью согласны. Спасибо за поддержку в минуты моей паники! Вообще спасибо за всё!" },
];
